...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContactStore = __webpack_require__(217);
	...
	var App = (function (_Component) {
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				...
				_ContactStore2.default.addListener(this.updateState.bind(this));
				_ContactStore2.default.init();
			}
		}, {
			key: 'componentWillUnmount',
			value: function componentWillUnmount() {
				_ContactStore2.default.removeListener(this.updateState.bind(this));
			...
			value: function updateState() {
				...
				this.setState(Object.assign(this.state, { contacts: _ContactStore2.default.getContacts() }));
			}
		}, {
			key: 'render',
	...
	var NewContact = (function (_Component3) {
		_inherits(NewContact, _Component3);

		function NewContact(props) {
			_classCallCheck(this, NewContact);

			var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(NewContact).call(this, props));
		...
		_createClass(NewContact, [{
			...
			value: function createNewContact(event) {
				var _this4 = this;

				event.preventDefault();
				_ContactStore2.default.addContact(this.state, function (contact) {
					return _this4.context.router.push('/contact/' + contact.id);
				});
			}
		}, {
			key: '_onChange',
			value: function _onChange(event) {
				...
				var state = Object.assign({}, this.state, _defineProperty({}, target.name, target.value));
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						null,
						_react2.default.createElement('input', { name: 'first', type: 'text',
							value: this.state.first,
							placeholder: 'first name',
							onChange: this._onChange.bind(this) }),
						_react2.default.createElement('input', { name: 'last', type: 'text',
					...
					_react2.default.createElement(
						'button',
						{ onClick: this.createNewContact.bind(this) },
						'保存联系人'
					),
					_react2.default.createElement(
						_reactRouter.Link,
	...
	NewContact.contextTypes = { router: _react2.default.PropTypes.object };
	...
	var Contact = (function (_Component4) {
		...
		function Contact(props) {
			...
			var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(Contact).call(this, props));

			_this5.state = _this5.getContactFromStore();
			return _this5;
		}

		_createClass(Contact, [{
			key: 'getContactFromStore',
			value: function getContactFromStore() {
				var props = arguments.length <= 0 || arguments[0] === undefined ? this.props.params : arguments[0];
				var id = props.id;
			...
			key: 'componentDidMount',
			value: function componentDidMount() {
				_ContactStore2.default.addListener(this.updateContact.bind(this));
			}
		}, {
			key: 'componentWillUnmount',
			value: function componentWillUnmount() {
				_ContactStore2.default.removeListener(this.updateContact.bind(this));
				this.state.isMounted = false;
			}
		}, {
	...
	var NotFound = (function (_Component5) {
		_inherits(NotFound, _Component5);
...
/***/ function(module, exports) {
	...
	var API = 'http://127.0.0.1:8080/contacts';
	var isInited = false;
	...
	var ContactStore = {
		init: function init() {
			...
			getJSON(API, function (err, contacts) {
				if (err) {
					console.log(err);
				}
		...
		removeContact: function removeContact(id) {
			removeJSON(API + '/' + id, function (err, contact) {
				delete _contacts[id];
				ContactStore.notifiyChange();
			});
		},
		addContact: function addContact(contact, cb) {
			addJSON(API, contact, function (err, contact) {
		...
		notifiyChange: function notifiyChange() {
